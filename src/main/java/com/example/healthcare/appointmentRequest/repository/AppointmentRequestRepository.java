package com.example.healthcare.appointmentRequest.repository;
...
public interface AppointmentRequestRepository extends JpaRepository<AppointmentRequest, Long> {
    ...
    WHERE ar.doctorId = :doctorId
      AND ar.status = com.example.healthcare.appointmentRequest.enums.AppointmentRequestStatus.PENDING
""")
